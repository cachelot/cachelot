...
BOOST_AUTO_TEST_CASE(test_basic) {
    ...
    BOOST_CHECK(first_word1 == bytes::from_literal("Hello"));
    BOOST_CHECK(rest1 == bytes::from_literal("World!"));
    ...
    BOOST_CHECK(first_word1 == first_word2);
    BOOST_CHECK(hello1.slice(0, hello1.length()-1) == hello2.slice(0, hello2.length()-1));
